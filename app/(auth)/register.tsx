                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    <View style={{ flex: 1, paddingHorizontal: 24, paddingTop: 8 }}>
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 20 }}>
                            ...
                            <Text style={{ marginHorizontal: 12, color: COLORS.mutedForeground, fontSize: 13 }}>или через</Text>
                            <View style={{ flex: 1, height: 1, backgroundColor: COLORS.border }} />
                        </View>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "center", paddingBottom: 24 }}>
                            <Text style={{ color: COLORS.mutedForeground, fontSize: 14 }}>уже есть аккаунт? </Text>
                            <TouchableOpacity onPress={() => router.push("/(auth)/login")}>
                                <Text style={{ color: COLORS.primary, fontWeight: "600", fontSize: 14 }}>Войти</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
