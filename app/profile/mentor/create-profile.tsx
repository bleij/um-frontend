            ...
            <LinearGradient colors={["#F8F7FF", "#EDE9FE"]} style={{ flex: 1 }}>
                ...
                <LinearGradient colors={["#6C5CE7", "#8B7FE8"]} className="pt-12 pb-4 px-4 shadow-sm z-10 rounded-b-3xl">
                    <SafeAreaView edges={["top"]} style={{ flexDirection: "row", alignItems: "center" }}>
                        ...
                        <Text className="text-xl font-bold text-white">Создать профиль ментора</Text>
                    </SafeAreaView>
                </LinearGradient>
                ...
                <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View className="bg-white rounded-2xl p-6 shadow-sm mb-6">
                        ...
                        <View className="space-y-4">
                            <View>
                                <Text className="text-sm font-medium text-gray-700 mb-1">Специализация</Text>
                                <TextInput
                            ...
                            <View>
                                <Text className="text-sm font-medium text-gray-700 mb-1">Опыт работы (лет)</Text>
                                <TextInput
                            ...
                            <View>
                                <Text className="text-sm font-medium text-gray-700 mb-1">О себе</Text>
                                <TextInput
