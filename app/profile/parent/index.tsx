...
export default function ParentProfile() {
    ...
    const menuItems = [
        { icon: "user" as const, label: "Редактировать профиль", action: () => setShowEditModal(true) },
        { icon: "bell" as const, label: "Уведомления", action: () => setShowNotificationsModal(true) },
        { icon: "credit-card" as const, label: "Способы оплаты", action: () => setShowPaymentModal(true) },
        { icon: "settings" as const, label: "Настройки", action: () => setShowSettingsModal(true) },
    ];
        ...
        <View style={{ flex: 1, backgroundColor: COLORS.background }}>
            <SafeAreaView edges={["top"]} style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingVertical: 12 }}>
                    ...
                    <Text style={{ fontSize: 20, fontWeight: "700", color: COLORS.foreground }}>Профиль</Text>
                </View>
                ...
                <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 100 }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{ color: COLORS.mutedForeground, marginBottom: 20 }}>parent@example.com</Text>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "center", gap: 16 }}>
                            <View style={{ alignItems: "center" }}>
                                ...
                                >
                                    <Text style={{ fontSize: 20, fontWeight: "800", color: "white" }}>{children.length}</Text>
                                </LinearGradient>
                                <Text style={{ fontSize: 12, color: COLORS.mutedForeground, fontWeight: "500" }}>Детей</Text>
                            </View>
                            <View style={{ alignItems: "center" }}>
                                <LinearGradient
                                    colors={[COLORS.primary, COLORS.secondary]}
                                ...
                                >
                                    <Text style={{ fontSize: 20, fontWeight: "800", color: "white" }}>{enrollmentsCount}</Text>
                                </LinearGradient>
                                <Text style={{ fontSize: 12, color: COLORS.mutedForeground, fontWeight: "500" }}>Записей</Text>
                            </View>
                        </View>
                    </View>
                ...
                <Modal visible={showEditModal} transparent animationType="slide">
                    <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "flex-end", padding: 16 }}>
                        <View style={{ backgroundColor: COLORS.card, borderRadius: RADIUS.lg, padding: 24 }}>
                            ...
                            {[
                                { label: "Полное имя", key: "full_name" as const, placeholder: "Введите полное имя" },
                                { label: "Возраст", key: "age" as const, placeholder: "Введите возраст", keyboard: "numeric" as const },
                                { label: "Телефон", key: "phone" as const, placeholder: "+7 (999) 123-45-67", keyboard: "phone-pad" as const },
                            ].map(field => (
                            ...
                            <View style={{ flexDirection: "row", gap: 10, marginTop: 8 }}>
                                ...
                                >
                                    <Text style={{ fontWeight: "600", color: COLORS.mutedForeground }}>Отмена</Text>
                                </Pressable>
                                <Pressable
                                ...
                                >
                                    <Text style={{ fontWeight: "600", color: "white" }}>Сохранить</Text>
                                </Pressable>
                            </View>
                        </View>
                    </View>
                ...
                <Modal visible={showNotificationsModal || showPaymentModal || showSettingsModal} transparent animationType="fade">
                    <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", padding: 16 }}>
                        <View style={{ backgroundColor: COLORS.card, borderRadius: RADIUS.lg, padding: 24 }}>
                            ...
                            <Text style={{ color: COLORS.mutedForeground }}>Этот раздел находится в разработке.</Text>
                        </View>
                    </View>
                </Modal>
            </SafeAreaView>
