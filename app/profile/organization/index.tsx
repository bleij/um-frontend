...
export default function OrgProfile() {
    ...
    const menuItems = [
        { icon: "briefcase" as const, label: "Организация", action: () => Alert.alert("В разработке") },
        { icon: "credit-card" as const, label: "Платежные реквизиты", action: () => Alert.alert("В разработке") },
            ...
            <SafeAreaView edges={["top"]} style={{ flex: 1 }}>
                ...
                <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 100 }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 22, fontWeight: "700", color: COLORS.foreground, marginBottom: 4, textAlign: "center" }}>
                            Звёздочка
                        </Text>
                        <Text style={{ color: COLORS.primary, fontWeight: "600", marginBottom: 20 }}>Центр развития</Text>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "center", gap: 16 }}>
                            <View style={{ alignItems: "center" }}>
                                ...
                                <Text style={{ fontSize: 12, color: COLORS.mutedForeground, fontWeight: "500" }}>Кружков</Text>
                            </View>
                            <View style={{ alignItems: "center" }}>
                                <LinearGradient
                                    colors={[COLORS.primary, COLORS.secondary]}
                                ...
                                >
                                    <Text style={{ fontSize: 18, fontWeight: "800", color: "white" }}>124</Text>
                                </LinearGradient>
                                <Text style={{ fontSize: 12, color: COLORS.mutedForeground, fontWeight: "500" }}>Студентов</Text>
                            </View>
                        </View>
                    </View>
