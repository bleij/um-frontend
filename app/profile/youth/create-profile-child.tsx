                ...
                <View className="flex-row justify-between">
                  ...
                  <View className="flex-1 ml-2">
                    ...
                    <View className="flex-row rounded-xl overflow-hidden border border-gray-200 bg-gray-50 h-[50px]">
                      <TouchableOpacity
                        onPress={() =>
                          setFormData({ ...formData, gender: "boy" })
                        }
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          setFormData({ ...formData, gender: "girl" })
                        }
              ...
              <View className="flex-row flex-wrap justify-between">
                {availableInterests.map((interest) => {
                  ...
                  return (
                    ...
                    >
                      <Text
                        className={`font-medium ${isSelected ? "text-pink-700" : "text-gray-600"}`}
                      >
                        {interest}
                      </Text>
                    </TouchableOpacity>
              ...
              <View className="flex-row flex-wrap mt-3 gap-2">
                {interests
                  ...
                  .map((interest) => (
                    <View
                      key={interest}
                      className="flex-row items-center bg-pink-100 rounded-full px-3 py-1 mr-2 mb-2"
                    >
