    ...
    <View style={{ flex: 1, backgroundColor: "#F9FAFB" }}>
      ...
      >
        ...
        <View style={{ alignItems: "center", marginTop: 20 }}>
          ...
          >
            <Text style={{ fontSize: 36, fontWeight: "800", color: "#6C5CE7" }}>
              {(child.name || "").charAt(0)}
            </Text>
          </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
        ...
        >
          ...
          <Text
            style={{ flex: 1, fontSize: 13, color: "#1E40AF", lineHeight: 18 }}
          >
            После прохождения теста здесь появятся рекомендации AI по кружкам и
            активностям.
          </Text>
        </View>
        ...
        >
          ...
          >
            ...
            <Text style={{ color: "#B45309", fontSize: 12, marginTop: 4 }}>
              Пройдите тест для получения персональных рекомендаций
            </Text>
          </View>

          <TouchableOpacity
            onPress={() => router.push("/profile/parent/testing" as any)}
            style={{
