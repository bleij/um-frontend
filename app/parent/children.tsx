        ...
        <View style={{ flex: 1, backgroundColor: "#6C5CE7" }}>
            ...
            <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }}>
                ...
                >
                    ...
                    <Text style={{ color: "#6C5CE7", fontWeight: "700", fontSize: 16, marginLeft: 10 }}>Добавить ребенка</Text>
                </TouchableOpacity>
                ...
                {children.length === 0 ? (
                    <View style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", borderRadius: 24, padding: 30, alignItems: "center" }}>
                        ...
                        <Text style={{ color: "#9CA3AF", fontSize: 13, marginTop: 8, textAlign: "center" }}>Нажмите кнопку выше, чтобы создать профиль для вашего ребенка</Text>
                    </View>
                ) : (
