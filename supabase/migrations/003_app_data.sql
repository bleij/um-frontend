...
-- Seed mentor groups for dev mentor
insert into public.mentor_groups (id, mentor_user_id, name, course, schedule, max_students, active) values
  ('g0000001-0000-4000-a000-000000000001', 'd0000000-0000-4000-a000-000000000004', 'Старшая группа A', 'Робототехника',    'Пн, Ср 15:00', 20, true),
  ('g0000001-0000-4000-a000-000000000002', 'd0000000-0000-4000-a000-000000000004', 'Middle Python',    'Программирование', 'Вт, Чт 16:45', 15, true),
  ('g0000001-0000-4000-a000-000000000003', 'd0000000-0000-4000-a000-000000000004', 'Младшая группа B', 'Робототехника',    'Сб 10:00',     20, false)
on conflict do nothing;
...
insert into public.student_goals (mentor_user_id, student_name, title, deadline_text, progress, color) values
  ('d0000000-0000-4000-a000-000000000004', 'Анна Петрова',  'Завершить курс по Робототехнике', '30 апреля', 85, '#6C5CE7'),
  ('d0000000-0000-4000-a000-000000000004', 'Максим Иванов', 'Улучшить навык коммуникации',     '15 мая',    60, '#00B894'),
  ('d0000000-0000-4000-a000-000000000004', 'Данияр Сеитов', 'Создать первый проект',            '1 июня',    30, '#F59E0B')
on conflict do nothing;
...
insert into public.learning_materials (mentor_user_id, title, material_type, icon_name, size_label, color) values
  ('d0000000-0000-4000-a000-000000000004', 'Введение в робототехнику',          'Презентация', 'file-text', '2.4 MB', '#6C5CE7'),
  ('d0000000-0000-4000-a000-000000000004', 'Основы программирования: Урок 1',   'PDF',         'book',      '1.1 MB', '#3B82F6'),
  ('d0000000-0000-4000-a000-000000000004', 'Задания по логике (Блок 3)',         'Документ',    'clipboard', '0.8 MB', '#F59E0B'),
  ('d0000000-0000-4000-a000-000000000004', 'Видео-урок: Сборка модели',          'Видео',       'video',     '45 MB',  '#00B894')
on conflict do nothing;

-- Seed mentor feedback
insert into public.mentor_feedback (mentor_user_id, teacher_name, student_name, tag, text) values
  ('d0000000-0000-4000-a000-000000000004', 'Смирнов (Шахматы)', 'Максим Иванов', 'Быстро усвоил',      'Отлично решил задачу, хотя отвлекался в начале.'),
  ('d0000000-0000-4000-a000-000000000004', 'Соколов (Роботы)',   'Анна Петрова',  'Проявила лидерство', 'Собрала команду и руководила процессом сборки.')
on conflict do nothing;

-- Seed student tasks for dev student user
insert into public.student_tasks (student_user_id, title, club, xp_reward, done) values
  ('d0000000-0000-4000-a000-000000000004', 'Нарисовать пейзаж',  'Художественная студия', 50, true),
  ('d0000000-0000-4000-a000-000000000004', 'Домашнее задание',   'Программирование',       40, false),
  ('d0000000-0000-4000-a000-000000000004', 'Выучить 10 слов',    'Английский язык',         30, false),
  ('d0000000-0000-4000-a000-000000000004', 'Пробежать 1 км',     'Футбол',                 45, false)
on conflict do nothing;
