...
import svgPaths from "./svg-1t6ucuqzsk";
import { imgRectangle68 } from "./svg-p5l49";
...
function Text({ text, additionalClassNames = "" }: TextProps) {
  return (
    <div className={clsx("absolute h-[49px] left-0 overflow-clip w-[393px]", additionalClassNames)}>
      <div className="absolute bg-white h-[41px] left-[32px] rounded-[15px] top-[4px] w-[328px]" />
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal h-[20px] leading-none left-[47px] text-[#3430b5] text-[20px] top-[14px] w-[87px]">{text}</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#4a49a3] overflow-clip relative rounded-[32px] size-full" data-name="Экран 14">
      ...
      <div className="absolute h-[117px] left-px overflow-clip top-[114px] w-[393px]">
        <div className="absolute font-['Manrope:ExtraBold',sans-serif] font-extrabold leading-none left-[35px] text-[29px] text-white top-[32px] w-[340px] whitespace-pre-wrap">
          <p className="mb-0">{`Создайте `}</p>
          <p>профиль ребенка</p>
        </div>
      </div>
      <div className="absolute h-[381px] left-px overflow-clip top-[231px] w-[393px]">
        <div className="absolute h-[49px] left-0 overflow-clip top-0 w-[393px]">
          <div className="absolute bg-white h-[41px] left-[32px] rounded-[15px] top-[4px] w-[328px]" />
          <p className="absolute font-['Manrope:Regular',sans-serif] font-normal h-[20px] leading-none left-[47px] text-[#3430b5] text-[20px] top-[14px] w-[43px]">Имя</p>
        </div>
        <Text text="Возраст" additionalClassNames="top-[64px]" />
        <div className="absolute h-[49px] left-0 overflow-clip top-[128px] w-[393px]">
          <div className="absolute bg-white h-[41px] left-[32px] rounded-[15px] top-[4px] w-[328px]" />
          <p className="absolute font-['Manrope:Regular',sans-serif] font-normal h-[20px] leading-none left-[47px] text-[#3430b5] text-[20px] top-[14px] w-[42px]">Пол</p>
        </div>
        <div className="absolute h-[49px] left-0 overflow-clip top-[192px] w-[393px]">
          <div className="absolute bg-white h-[41px] left-[32px] rounded-[15px] top-[4px] w-[328px]" />
          <p className="absolute font-['Manrope:Regular',sans-serif] font-normal h-[20px] leading-none left-[47px] text-[#3430b5] text-[20px] top-[14px] w-[72px]">Школа</p>
        </div>
        <div className="absolute h-[49px] left-0 overflow-clip top-[256px] w-[393px]">
          <div className="absolute bg-white h-[41px] left-[32px] rounded-[15px] top-[4px] w-[328px]" />
          <p className="absolute font-['Manrope:Regular',sans-serif] font-normal h-[20px] leading-none left-[47px] text-[#3430b5] text-[20px] top-[14px] w-[111px]">Интересы</p>
        </div>
        <Text text="Цель" additionalClassNames="top-[320px]" />
      </div>
      <div className="absolute h-[63px] left-[86px] overflow-clip top-[612px] w-[223px]">
        <div className="absolute border border-[#f9f9f9] border-solid h-[47px] left-[36px] rounded-[100px] top-[7px] w-[151px]" />
        <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[normal] left-[60px] text-[17px] text-white top-[19px] whitespace-nowrap">продолжить</p>
      </div>
    </div>
  );
}