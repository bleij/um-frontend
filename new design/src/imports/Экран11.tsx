import svgPaths from "./svg-238kj2rvdz";
import { imgRectangle68 } from "./svg-g10y0";
...
export default function Component() {
  return (
    <div className="bg-gradient-to-b from-[#4745bc] overflow-clip relative rounded-[32px] size-full to-[#b9c1e8]" data-name="Экран 11">
      ...
      <div className="absolute h-[130px] left-[-1px] overflow-clip top-[697px] w-[393px]">
        ...
        <div className="absolute bg-gradient-to-r border border-[#8d91d7] border-solid from-[rgba(32,29,97,0.93)] h-[80px] left-[19px] rounded-[38px] to-[98.558%] to-[rgba(33,33,96,0.93)] top-[22px] via-[45.673%] via-[rgba(93,90,159,0.93)] w-[240px]" />
        <p className="absolute font-['Prosto_One:Regular',sans-serif] h-[26px] leading-[normal] left-[33px] not-italic text-[18px] text-white top-[49px] w-[351px]">Следующий вопрос</p>
        <div className="absolute h-[14.769px] left-[320px] top-[55px] w-[39.423px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[201px] not-italic text-[36px] text-center text-white top-[142px] w-[418px]">{`Тестирование `}</p>
      <div className="absolute bg-[rgba(217,217,217,0.37)] h-[35px] left-[29px] rounded-[30px] top-[209px] w-[336px]" />
      <div className="absolute h-[378px] left-[-10px] top-[283px] w-[377px]">
        <div className="absolute bg-[rgba(217,217,217,0.97)] h-[378px] left-[38px] rounded-[30px] top-0 w-[339px]" />
        <div className="absolute bg-[rgba(82,81,192,0.07)] border border-[rgba(71,69,188,0.43)] border-solid h-[56px] left-[49px] rounded-[30px] top-[124px] w-[315px]" />
        <div className="absolute bg-[rgba(82,81,192,0.07)] border border-[rgba(71,69,188,0.43)] border-solid h-[56px] left-[49px] rounded-[30px] top-[208px] w-[315px]" />
        <div className="absolute bg-[rgba(82,81,192,0.07)] border border-[rgba(71,69,188,0.43)] border-solid h-[56px] left-[49px] rounded-[30px] top-[292px] w-[315px]" />
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[120.5px] not-italic text-[18px] text-[rgba(46,44,121,0.55)] text-center top-[9px] w-[241px]">{`Вопрос 1/10 `}</p>
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[349.5px] not-italic text-[18px] text-[rgba(46,44,121,0.55)] text-center top-[9px] w-[241px]">?</p>
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[207.5px] not-italic text-[#2e2c79] text-[18px] text-center top-[59px] w-[317px]">Что больше всего интересует вашего ребенка ?</p>
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[196.5px] not-italic text-[#2e2c79] text-[18px] text-center top-[137px] w-[317px]">другое</p>
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[196.5px] not-italic text-[#2e2c79] text-[18px] text-center top-[221px] w-[317px]">другое</p>
        <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[196.5px] not-italic text-[#2e2c79] text-[18px] text-center top-[305px] w-[317px]">другое</p>
      </div>
      <div className="absolute left-[317px] size-[36px] top-[209px]" data-name="image-Photoroom 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImagePhotoroom1} />
      </div>
      <div className="absolute bg-gradient-to-r border border-[#8d91d7] border-solid from-[rgba(59,57,138,0.93)] h-[35px] left-[29px] rounded-[38px] to-[98.558%] to-[rgba(39,39,132,0.93)] top-[209px] via-[45.673%] via-[rgba(95,92,179,0.93)] w-[229px]" />
      <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[43px] leading-[normal] left-[102.5px] not-italic text-[18px] text-center text-white top-[215px] w-[241px]">{`5 минут `}</p>
    </div>
  );
}