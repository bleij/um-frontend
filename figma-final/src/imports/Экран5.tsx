import svgPaths from "./svg-1zzcnl0sb4";
import { imgRectangle68 } from "./svg-2vq3c";
...
export default function Component() {
  return (
    <div className="bg-gradient-to-b from-[#4745bc] overflow-clip relative rounded-[32px] size-full to-[#b9c1e8]" data-name="Экран 5">
      ...
      <div className="absolute h-[130px] left-0 overflow-clip top-[722px] w-[393px]">
        <div className="absolute h-[130px] left-[196px] opacity-84 overflow-clip top-0 w-[197px]">
          <div className="absolute bg-[#3430b5] h-[130px] left-0 rounded-tl-[100px] top-0 w-[197px]" />
          <p className="absolute font-['Lexend:Regular',sans-serif] font-normal leading-[normal] left-[43px] text-[31px] text-white top-[46px]">Sign up</p>
        </div>
        <div className="absolute h-[130px] left-0 overflow-clip top-0 w-[196px]">
          <p className="absolute font-['Lexend:Regular',sans-serif] font-normal leading-[normal] left-[49px] text-[31px] text-black top-[46px]">Sign in</p>
        </div>
      </div>
      ...
      <div className="absolute h-[100px] left-[67px] overflow-clip top-[224px] w-[258px]">
        <p className="absolute font-['Sixtyfour:Maximum',sans-serif] leading-[normal] left-[49px] text-[80px] text-white top-[10px]" style={{ fontVariationSettings: "'BLED' 0, 'SCAN' 100" }}>
          UM
        </p>
      </div>
    </div>
