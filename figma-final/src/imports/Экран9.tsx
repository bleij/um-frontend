...
import svgPaths from "./svg-w5wl2qe9wc";
import { imgRectangle68 } from "./svg-karr2";
...
function Frame1Helper({ children, additionalClassNames = "" }: React.PropsWithChildren<Frame1HelperProps>) {
  return (
...
export default function Component() {
  return (
    <div className="bg-gradient-to-b from-[#4745bc] overflow-clip relative rounded-[32px] size-full to-[#b9c1e8]" data-name="Экран 9">
      ...
      <div className="absolute h-[130px] left-[-1px] overflow-clip top-[697px] w-[393px]">
        ...
        <div className="absolute bg-gradient-to-r border border-[#8d91d7] border-solid from-[rgba(51,50,148,0.93)] h-[80px] left-[20px] rounded-[38px] to-[98.558%] to-[rgba(40,40,129,0.93)] top-[21px] via-[45.673%] via-[rgba(82,79,142,0.93)] w-[189px]" />
        <div className="absolute left-[147px] size-[50px] top-[34px]">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 50">
            <circle cx="25" cy="25" fill="var(--fill-0, #5251C0)" fillOpacity="0.67" id="Ellipse 4" r="25" />
          </svg>
        </div>
        <div className="absolute flex h-[8.35px] items-center justify-center left-[165px] top-[54px] w-[12.461px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
          <Frame1Helper additionalClassNames="rotate-[33.83deg]">
            <line id="Line 9" stroke="var(--stroke-0, white)" strokeWidth="3" x2="15" y1="1.5" y2="1.5" />
          </Frame1Helper>
        </div>
        <div className="absolute flex h-[8.964px] items-center justify-center left-[167px] top-[61px] w-[12.027px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
          <Frame1Helper additionalClassNames="rotate-[-36.7deg]">
            <line id="Line 10" stroke="var(--stroke-0, white)" strokeWidth="3" x2="15" y1="1.5" y2="1.5" />
          </Frame1Helper>
        </div>
        <p className="absolute font-['Prosto_One:Regular',sans-serif] leading-[normal] left-[35px] not-italic text-[26px] text-white top-[46px] whitespace-nowrap">{`Начать `}</p>
        <div className="absolute h-[14.769px] left-[312px] top-[55px] w-[39.423px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Solway:Medium','Noto_Sans:Bold',sans-serif] h-[110px] leading-[0] left-[198.5px] text-[0px] text-center text-white top-[133px] w-[313px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>
        ...
        <span className="font-['Seymour_One:Regular','Noto_Sans:Bold',sans-serif] leading-[normal] text-[#333289] text-[36px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>
          UMO!
        </span>
      </p>
      ...
      <p className="-translate-x-1/2 absolute font-['Prosto_One:Regular',sans-serif] h-[102px] leading-[normal] left-[262.5px] not-italic text-[#2a295f] text-[18px] text-center top-[285px] w-[225px]">{`Давай начнем наше тестирование `}</p>
