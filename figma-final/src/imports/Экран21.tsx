import svgPaths from "./svg-l35k5e10zv";
import { imgRectangle68 } from "./svg-02uv1";
import imgImagePhotoroom41 from "figma:asset/c485fc6c0ec83840170d551a1e77f66e5d140228.png";
...
function Bar({ className, mode = "Dark Content" }: BarProps) {
  return (
    <div className={className || "h-[5px] relative w-[134px]"}>
...
export default function Component() {
  return (
    <div className="bg-[#f1f0ff] overflow-clip relative rounded-[32px] size-full" data-name="Экран 21">
      ...
      <div className="absolute h-[163px] left-[56px] top-[111px] w-[297px]" data-name="image-Photoroom-4 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[216.56%] left-[-18.86%] max-w-none top-[-26.38%] w-[118.86%]" src={imgImagePhotoroom41} />
        </div>
      </div>
      <div className="absolute h-[65px] left-[56px] overflow-clip top-[71px] w-[278px]">
        <p className="absolute font-['Prosto_One:Regular',sans-serif] leading-[normal] left-[44px] not-italic text-[32px] text-black top-[10px] whitespace-nowrap">Результаты</p>
      </div>
      <div className="absolute h-[140px] left-[131px] top-[144px] w-[131px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 131 140">
          <g id="Frame 45">
            <path d={svgPaths.p3a7f6b80} fill="var(--fill-0, #FBBC05)" id="Star 1" />
          </g>
        </svg>
      </div>
      <div className="absolute h-[48px] left-[113px] overflow-clip top-[260px] w-[183px]">
        <p className="absolute font-['Prosto_One:Regular',sans-serif] leading-[normal] left-0 not-italic text-[22px] text-black top-[11px] w-[197px]">Тип личности</p>
      </div>
      <div className="absolute border-2 border-[#362d8c] border-solid h-[160px] left-[43px] overflow-clip rounded-[20px] top-[308px] w-[306px]">
        <div className="absolute bg-[rgba(255,255,255,0)] h-[160px] left-[-2px] rounded-[12px] top-[-2px] w-[306px]" />
        <div className="absolute h-[160px] left-[-2px] overflow-clip top-[-2px] w-[306px]">
          <p className="absolute font-['Prosto_One:Regular',sans-serif] h-[42px] leading-[normal] left-[65px] not-italic text-[17px] text-black top-[71px] w-[177px]">краткое описание</p>
        </div>
      </div>
      <div className="absolute h-[251px] left-[43px] overflow-clip top-[459px] w-[306px]">
        <div className="absolute font-['Prosto_One:Regular',sans-serif] leading-[normal] left-0 not-italic text-[17px] text-black top-[182px] whitespace-nowrap">
          <p className="mb-0">Отчет:</p>
          <p className="mb-0">креативность - 90%</p>
          <p>аналитика 65%</p>
        </div>
        <div className="absolute h-[182px] left-0 top-0 w-[306px]">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 306 182">
            <g id="Frame 50">
              <path d={svgPaths.p17b0eb80} id="Vector" stroke="var(--stroke-0, #2E2C79)" strokeWidth="2" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute h-[130px] left-[8px] overflow-clip top-[705px] w-[393px]">
        <div className="absolute bg-gradient-to-r from-[rgba(38,24,97,0.98)] h-[66px] left-[76px] rounded-[38px] to-[92.308%] to-[rgba(31,27,85,0.98)] top-[29px] via-[48.077%] via-[rgba(86,83,178,0.98)] w-[228px]" />
        <div className="absolute h-[130px] left-0 top-0 w-[196px]" />
        <p className="absolute font-['Prosto_One:Regular',sans-serif] h-[26px] leading-[normal] left-[128px] not-italic text-[18px] text-white top-[52px] w-[137px]">{`Продолжить `}</p>
      </div>
    </div>
  );
}