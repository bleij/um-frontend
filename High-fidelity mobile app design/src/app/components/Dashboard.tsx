...
import { Moon, Sun, Sparkles, Brain, Target, Users } from "lucide-react";
    ...
    <div className="px-6 pt-8 pb-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <div className={`w-10 h-10 rounded-3xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center ${isDark ? 'shadow-[0_0_20px_rgba(183,148,246,0.6)]' : 'shadow-lg'}`}>
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <h1 className="text-2xl">UM</h1>
          </div>
          <p className="text-muted-foreground text-sm">Universal Mind</p>
        </div>
      ...
      >
        ...
        <div className="h-[280px]">
          <TalentRadar data={talentData} isDark={isDark} instanceId="dashboard" />
        </div>
      </motion.div>
        ...
        {insights.map((insight, index) => (
          ...
          >
            <div className="flex gap-4">
              <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${isDark ? 'from-primary/20 to-secondary/20' : 'from-primary/10 to-secondary/10'} flex items-center justify-center flex-shrink-0`}>
